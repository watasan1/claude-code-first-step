...
本資料は、Claudeを初めて使う方を対象に、アカウント作成からClaude Code の導入、そして実際にHTML/CSS/JavaScriptでTodoリストアプリを完成させるまでを、一連の流れで体験できるようにまとめたものです。
...
windowsで利用する場合は、Claude Codeのインストール前にGitをインストールしてください。
...
表示された項目を確認・入力し、「続ける」ボタンをクリックします。
