...
### Step 5 「ワークスペースを信頼しますか？」と表示されたら、「ワークスペースを信頼する」ボタンをクリックします。
...
### Step 7 Claudeデスクトップアプリの画面構成を確認する
